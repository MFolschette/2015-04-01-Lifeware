...
\medskip
\footnotesize
FMV team / Department of Electronics \& Informatics / University of Kassel

\texttt{maxime.folschette@uni-kassel.de}
...
% Semantics of Biological Regulatory Networks
\newcommand{\cbccdmrcmmb}{Bernot \textit{et al.} in \textit{Concurrent Models in Molecular Biology}, 2007}
...
\section{Inference of the Underlying Thomas Models}
\input{parts/inf.tex}
