...
\tikzstyle{labelprio4}=[labelprio, fill=brown!30, draw=brown!80, thick]
...
\tikzstyle{Async}=[node distance=1.2cm, draw, double]
...
\tikzstyle{stategraph}=[node distance=3cm, ->]
...
\tikzstyle{grosarca}=[ultra thick, couleurtheme!70, line cap=round]
\tikzstyle{grosarcb}=[grosarca, darkcyan!70]
